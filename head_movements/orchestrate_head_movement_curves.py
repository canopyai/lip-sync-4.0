...
from head_movements.interpolate_with_easing import smoothen_curves
from head_movements.interpolate_with_easing import interpolate_with_easing
...
def orchestrate_head_movement_curves(segments):
    ...
    int_alvs = interpolate_with_easing(int_alvs)
